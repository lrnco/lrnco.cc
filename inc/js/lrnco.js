...
$(".bioblast-3").hover(function(){$(".fp-viewing-bioblast").addClass("bioblast3");},function(){$(".fp-viewing-bioblast").removeClass("bioblast3");});

$(".bioblast-2").hover(function(){$(".fp-viewing-bioblast").addClass("bioblast2");},function(){$(".fp-viewing-bioblast").removeClass("bioblast2");});

$(".bioblast-4").hover(function(){$(".fp-viewing-bioblast").addClass("bioblast4");},function(){$(".fp-viewing-bioblast").removeClass("bioblast4");});




$(".copyright").text( 'Luciano Liranço © ' + (new Date).getFullYear() );